...
namespace Manzadey\LaravelLike\Test;

use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Schema\Blueprint;
use Manzadey\LaravelLike\LikeServiceProvider;
use Manzadey\LaravelLike\Test\Models\Article;
use Manzadey\LaravelLike\Test\Models\Company;
use Manzadey\LaravelLike\Test\Models\Post;
use Manzadey\LaravelLike\Test\Models\User;
...
abstract class TestCase extends OrchestraTestCase
{
    ...
    {
        (include __DIR__ . '/../database/migrations/create_likes_table.php')->up();
    }
